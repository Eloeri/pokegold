MoveRelearner:
	; Loads and prints the "MoveRelearnerIntroText" text and places
	...
	; Loads and prints the "MoveRelearnerWhichMonText" text.
	ld hl, MoveRelearnerWhichMonText
	call PrintText
...
.loop_party_menu
	...
	; Loads and prints the "MoveRelearnerWhichMoveText" text.
...
; Loads and prints the "MoveRelearnerCancelText" text.
; This ends the dialogue.
.cancel
	ld hl, MoveRelearnerCancelText
	jp PrintText

; Loads and prints the "MoveRelearnerEggText" text and then waits for
; the player to press a button for the text to progress. Then
; relative jump to the ".loop_party_menu" local jump.
.is_an_egg
	ld hl, MoveRelearnerEggText
	call PrintText
	jr .loop_party_menu

; Loads and prints the "MoveRelearnerNotaMonText" text and then waits
; for the player to press a button for the text to progress. Then
; relative jump to the ".loop_party_menu" local jump.
.not_a_pokemon
	ld hl, MoveRelearnerNotaMonText
	call PrintText
	jr .loop_party_menu

; Loads and prints the "MoveRelearnerNoMovesText" text and then waits
; for the player to press a button for the text to progress. Then
; relative jump to the ".loop_party_menu" local jump.
.no_moves_to_learn
...
; Loads and prints the "MoveRelearnerNotEnoughMoneyText" text.
...
; the "MoveRelearnerMoveLearnedText" text.
.move_learned
	call ReturnToMapWithSpeechTextbox
	ld hl, MoveRelearnerMoveLearnedText
	jp PrintText
...
; finally prints the "MoveRelearnerPaymentReceivedText" text.
.pay_for_move
	farcall PlaceMoneyTopRight
	ld hl, MoveCost
	ld de, hMoneyTemp
	...
	call PlaySFX
	call WaitSFX
	ld hl, MoveRelearnerPaymentReceivedText
	call PrintText
...
MoveRelearnerPaymentReceivedText:
	text "Pleasure doing"
	line "business with"
	cont "you!"
	prompt